 ...
 ******************************************************************************/
extern inline double_eno_derivative eno_derivative( double v4, double v1, double v0, double v2, double v3, double pr, double pl, double ds)
{
	double p2m, dsp;
...
{
	#pragma omp parallel for default(none) shared(step, re_lsf, mask, deltat, xpr, xpl, ypf, ypb, zpu, zpd, rows, cols, pges, dx, dy, dz, num_ele)
